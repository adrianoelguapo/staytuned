    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h1 class="h2 text-white mb-0">Seguidores de <?php echo e($user->name); ?></h1>
                    <p class="text-light mb-0"><?php echo e($followers->total()); ?> seguidores</p>
                </div>
            </div>
                            ...
                            <div class="card dashboard-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <!-- Foto de perfil -->
                                        <img src="<?php echo e($follower->profile_photo_url); ?>" 
                                    ...
                                    <div class="mt-3 d-flex gap-2">
                                        <a href="<?php echo e(route('explore.users.show', $follower)); ?>" 
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(Auth::id() !== $follower->id): ?>
                                                ...
                                                <button type="button" 
                                                        ...
                                                        data-user-id="<?php echo e($follower->id); ?>"
