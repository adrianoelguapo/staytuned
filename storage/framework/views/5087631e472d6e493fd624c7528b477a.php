    ...
    <body class = "dashboard-body">
        ...
        <nav class = "navbar navbar-expand-lg px-5 py-3">
            ...
            <div class = "d-none d-lg-flex ms-auto align-items-center gap-3">
                ...
                <a href = "<?php echo e(route('communities.index')); ?>" class = "nav-link-inline <?php echo e(request()->routeIs('communities.*') ? 'active' : ''); ?>">
                ...
                <div class = "dropdown">
                    <a class = "d-flex align-items-center text-white dropdown-toggle nav-link-inline" href = "#" id = "userDropdown" role = "button" data-bs-toggle = "dropdown" aria-expanded = "false">
                        ...
                        <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                            ...
                            <img src = "<?php echo e(Auth::user()->profile_photo_url); ?>" class = "rounded-circle me-2 user-photo" alt = "<?php echo e(Auth::user()->name); ?>" style = "width: 32px; height: 32px; object-fit: cover;"/>
...
</html><?php /**PATH C:\laragon\www\staytuned\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>