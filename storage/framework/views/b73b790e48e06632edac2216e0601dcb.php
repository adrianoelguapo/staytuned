<?php if($communityPosts && $communityPosts->count() > 0): ?>
    ...
    <?php if($communityPosts->hasPages()): ?>
        ...
        <div class = "d-flex justify-content-center mt-4">
            ...
            <?php echo e($communityPosts->appends(request()->except('community_page'))->links('pagination::bootstrap-4', ['class'  => 'pagination-custom'])); ?>
    ...
    <div class = "card dashboard-card">
        ...
        <div class = "card-body text-center py-5">
            ...
            <div class="d-flex justify-content-center">
                <a href="<?php echo e(route('communities.index')); ?>" class="btn btn-outline-light d-inline-flex align-items-center">Explorar comunidades</a>
            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\staytuned\resources\views/dashboard/partials/community-posts.blade.php ENDPATH**/ ?>