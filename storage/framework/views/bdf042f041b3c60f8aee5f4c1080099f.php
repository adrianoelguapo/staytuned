            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card create-playlist-card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('playlists.store')); ?>" method="POST" enctype="multipart/form-data" class="playlist-form">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  rows="4" 
                                                  maxlength="500"
                                                  placeholder="Describe tu playlist..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" 
                                                   ...
                                                   id="public" 
                                                   value="1" 
                                                   <?php echo e(old('is_public', '1') == '1' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" 
                                                   ...
                                                   id="private" 
                                                   value="0" 
                                                   <?php echo e(old('is_public') == '0' ? 'checked' : ''); ?>>
                            ...
                            <div class="d-flex gap-3 justify-content-end">
                                <a href="<?php echo e(route('playlists.index')); ?>" class="btn btn-secondary">
...
<?php /**PATH C:\laragon\www\staytuned\resources\views/playlists/create.blade.php ENDPATH**/ ?>