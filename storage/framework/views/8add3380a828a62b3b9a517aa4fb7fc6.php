...
<head>
    ...
    <title>Editar <?php echo e($playlist->name); ?> | StayTuned</title>
            ...
            <div class="col-12 col-lg-8">
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('playlists.show', $playlist)); ?>" class="text-white-50"><?php echo e($playlist->name); ?></a>
                        </li>
                ...
                <div class="card create-playlist-card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('playlists.update', $playlist)); ?>" method="POST" enctype="multipart/form-data" class="playlist-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="playlist-image-upload">
                                        <div class="image-preview" id="imagePreview">                                            <?php if($playlist->cover): ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  rows="4" 
                                                  maxlength="500"
                                                  placeholder="Describe tu playlist..."><?php echo e(old('description', $playlist->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" 
                                                   ...
                                                   id="public" 
                                                   value="1" 
                                                   <?php echo e(old('is_public', $playlist->is_public) == '1' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" 
                                                   ...
                                                   id="private" 
                                                   value="0" 
                                                   <?php echo e(old('is_public', $playlist->is_public) == '0' ? 'checked' : ''); ?>>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        Esta playlist contiene <strong><?php echo e($playlist->songs->count()); ?></strong> canciones.
                            ...
                            <div class="d-flex gap-3 justify-content-end">
                                <a href="<?php echo e(route('playlists.show', $playlist)); ?>" class="btn btn-secondary">
                    ...
                    <div class="card create-playlist-card mt-4">
                        <div class="card-body">
                            ...
                            <div class="songs-preview">
                                <?php $__currentLoopData = $playlist->songs->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $song): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="song-preview-item">
                                        ...
                                        <div class="song-preview-info">
                                            <div class="song-preview-title"><?php echo e($song->title); ?></div>
                                            <div class="song-preview-artist"><?php echo e($song->artist); ?></div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                
                                <?php if($playlist->songs->count() > 5): ?>
                                    <div class="text-muted mt-2">
                                        Y <?php echo e($playlist->songs->count() - 5); ?> canciones más...
                                    </div>
                                <?php endif; ?>
                            </div>
                            
                            <div class="mt-3">
                                <a href="<?php echo e(route('playlists.show', $playlist)); ?>" class="btn btn-sm btn-outline-light">
...
<?php /**PATH C:\laragon\www\staytuned\resources\views/playlists/edit.blade.php ENDPATH**/ ?>