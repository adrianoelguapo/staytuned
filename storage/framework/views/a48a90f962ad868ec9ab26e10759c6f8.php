                            ...
                            <div class="d-flex justify-content-between align-items-start mb-4 pb-4 border-bottom border-light border-opacity-25">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        <a href="<?php echo e(route('explore.users.show', $post->user)); ?>" class="text-decoration-none">
                                            <?php if($post->user->profile_photo_url): ?>
                                                <img src="<?php echo e($post->user->profile_photo_url); ?>" 
                                                     ...
                                                     class="rounded-circle me-3 post-author-photo"
                                                     style="width: 48px; height: 48px; object-fit: cover;">
                                            <?php else: ?>
                                                <div class="bg-light bg-opacity-25 rounded-circle d-flex align-items-center justify-content-center me-3 post-author-photo"
                                        ...
                                        <div>
                                            <a href="<?php echo e(route('explore.users.show', $post->user)); ?>" class="text-decoration-none">
                                                <h5 class="text-white fw-semibold mb-1 post-author-name"><?php echo e($post->user->username); ?></h5>
                                            </a>
                                            ...
                                            <div class="flex-shrink-0">
                                                <a href="<?php echo e(route('explore.users.show', $comment->user)); ?>" class="text-decoration-none">
                                                    <?php if($comment->user->profile_photo_path): ?>
                                                        <img class="rounded-circle comment-author-photo" 
                                                             src="<?php echo e($comment->user->profile_photo_url); ?>" 
                                                             alt="<?php echo e($comment->user->username); ?>"
                                                             style="width: 32px; height: 32px; object-fit: cover;">
                                                    <?php else: ?>
                                                        <div class="bg-light bg-opacity-25 rounded-circle d-flex align-items-center justify-content-center comment-author-photo"
