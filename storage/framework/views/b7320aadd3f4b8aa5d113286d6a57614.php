...
<div class="container-xl">    <!-- Community Header -->
                    ...
                    <div class="community-actions-header">
                        <div class="dropdown d-inline">
                            ...
                            <ul class="dropdown-menu">
                                <?php if($isOwner): ?>
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(route('communities.edit', $community)); ?>">
    ...
    <div class="community-posts">        <div class="community-posts-header">
            ...
            <div class="community-empty">
                ...
                <?php if($isMember || $isOwner): ?>
                    <a href="<?php echo e(route('communities.create-post', $community)); ?>" class="btn-community btn-community-primary mt-3">
                        <i class="fas fa-plus me-2"></i>
