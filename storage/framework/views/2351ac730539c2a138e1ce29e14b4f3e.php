...
<div class="container-xl">    <!-- Header -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('communities.create')); ?>" class="btn-community btn-community-primary">
    ...
    <div class="community-empty">
        ...
        <a href="<?php echo e(route('communities.create')); ?>" class="btn-community btn-community-primary mt-3">
            <i class="fas fa-plus me-2"></i>
