...
<html lang="es">
    ...
    <body class="dashboard-body">
                                            ...
                                            <div class="post-info-container">
                                                ...
                                                <div class="post-footer-section">
                                                    ...
                                                    <div class="post-actions-section">
                                                        ...
                                                        <button onclick="toggleLike(<?php echo e($post->id); ?>)" class="like-btn <?php echo e(Auth::check() && $post->isLikedBy(Auth::user()) ? 'liked' : ''); ?>" data-post-id="<?php echo e($post->id); ?>" data-liked="<?php echo e(Auth::check() && $post->isLikedBy(Auth::user()) ? 'true' : 'false'); ?>">
                                                        ...
                                                        <?php if($post->user_id === Auth::id()): ?>
                                                            ...
                                                            <div class="post-actions-buttons">
                                                                ...
                                                                <a href="<?php echo e(route('posts.show', $post)); ?>" class="btn btn-glass-action" title="Ver publicación">

                                                                    <i class="bi bi-eye me-1"></i>Ver

                                                                </a>

                                                                <a href="<?php echo e(route('posts.edit', $post)); ?>" class="btn btn-glass-action" title="Editar publicación">
                                                                ...
                                                                <form action="<?php echo e(route('posts.destroy', $post)); ?>" method="POST" style="display: inline;">
                                                                    ...
                                                                    <button type="submit" class="btn btn-glass-action btn-glass-danger" title="Eliminar publicación">
        ...
        <script src="<?php echo e(asset('js/posts.js')); ?>"></script>

    </body>

</html><?php /**PATH C:\laragon\www\staytuned\resources\views/posts/index.blade.php ENDPATH**/ ?>