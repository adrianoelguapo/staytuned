    ...
    <body class = "login-body">
        ...
        <div class = "login-container d-flex flex-column flex-lg-row align-items-stretch pb-4">
                ...
                <div class = "login-box w-100">
                    ...
                    <form method = "POST" action = "<?php echo e(route('register')); ?>" enctype = "multipart/form-data">
                        ...
                        <div class = "mb-3">
                            ...
                            <input id = "username" name = "username" type = "text" value = "<?php echo e(old('username')); ?>" required autofocus class = "form-control">
                        ...
                        <div class = "mb-3">
                            ...
                            <input id = "name" name = "name" type = "text"value = "<?php echo e(old('name')); ?>" required class = "form-control">
                        ...
                        <div class = "mb-3">
                            ...
                            <input id = "email" name = "email" type = "email" value = "<?php echo e(old('email')); ?>" required class = "form-control">
                        ...
                        <div class = "text-center mt-4 text-white-50 small">
                            ...
                            ¿Ya tienes una cuenta? <a href = "<?php echo e(route('login')); ?>" class = "text-decoration-underline text-white">Inicia sesión</a>
            ...
            <div class = "login-right d-none d-lg-flex justify-content-center align-items-center p-4">
                ...
                <img src = "<?php echo e(asset('img/login7.png')); ?>" alt = "Ilustración de registro" class = "img-fluid me-5">
...
</html><?php /**PATH C:\laragon\www\staytuned\resources\views/auth/register.blade.php ENDPATH**/ ?>