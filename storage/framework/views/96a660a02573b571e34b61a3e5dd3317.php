        ...
        <div class = "col-12 col-lg-10">
            ...
            <div class = "d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <h1 class = "h2 text-white mb-0"><?php echo e($user->username); ?> está siguiendo</h1>
                            ...
                            <div class = "card dashboard-card">
                                ...
                                <div class = "card-body">
                                    ...
                                    <div class = "d-flex align-items-center">
                                        ...
                                        <img src = "<?php echo e($followedUser->profile_photo_url); ?>"  alt = "<?php echo e($followedUser->name); ?>"  class = "rounded-circle me-3" style = "width: 60px; height: 60px; object-fit: cover;">
                                    ...
                                    <div class = "mt-3 d-flex gap-2">
                                        ...
                                        <a href = "<?php echo e(route('explore.users.show', $followedUser)); ?>"  class = "btn btn-outline-light btn-sm flex-fill">
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            ...
                                            <?php if(Auth::id() ! =  =  $followedUser->id): ?>
                                                ...
                                                <button type = "button" class = "btn btn-sm follow-btn <?php echo e($isFollowing ? 'btn-secondary' : 'btn-primary'); ?>" data-user-id = "<?php echo e($followedUser->id); ?>" data-following = "<?php echo e($isFollowing ? 'true' : 'false'); ?>">
