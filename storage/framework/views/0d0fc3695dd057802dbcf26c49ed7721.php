        ...
        <div class = "twofactor-container mb-5">
            ...
            <div class = "twofactor-box" x-data = "{ recovery: false }">
                ...
                <div class = "mb-4 text-white-50 small" x-show = "! recovery">
                    ...
                    <?php echo e(__('Confirma el acceso ingresando el código de tu app de autenticación.')); ?>
                ...
                <div class = "mb-4 text-white-50 small" x-show = "recovery" x-cloak>
                    ...
                    <?php echo e(__('Introduce uno de tus códigos de recuperación de emergencia.')); ?>
...
</html><?php /**PATH C:\laragon\www\staytuned\resources\views/auth/two-factor-challenge.blade.php ENDPATH**/ ?>