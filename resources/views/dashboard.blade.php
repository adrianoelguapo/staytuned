            ...
            <div class="col-12 col-lg-10">
                ...
                <div class="mb-5">
                    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
                        ...
                        <a href="{{ route('explore.users.index') }}" class="btn btn-outline-light btn-sm w-100 dashboard-action-btn">
                ...
                <div class="mb-5">
                    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
                        ...
                        <a href="{{ route('communities.index') }}" class="btn btn-outline-light btn-sm w-100 dashboard-action-btn">
        ...
        function convertToAjaxUrl(originalUrl, contentType) {
            try {
                ...
                if (contentType === 'following') {
                    ajaxUrl = `{{ route('dashboard.following-posts') }}?following_page=${page}`;
                } else if (contentType === 'community') {
                    ajaxUrl = `{{ route('dashboard.community-posts') }}?community_page=${page}`;
                } else {
                    ajaxUrl = originalUrl;
                }
