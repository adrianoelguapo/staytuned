                    ...
                    <form method="GET" action="{{ route('explore.users.index') }}" class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select custom-sort-select" 
                                ...
                                <option value="followers" {{ request('sort_by') == 'followers' ? 'selected' : '' }}>
                                    Más seguidos
                                </option>
                                ...
                                <option value="playlists" {{ request('sort_by') == 'playlists' ? 'selected' : '' }}>
                                    Más playlists
                                </option>
                                <option value="posts" {{ request('sort_by') == 'posts' ? 'selected' : '' }}>
                                    Más publicaciones
                                </option>
                            </select>
                        </div>
