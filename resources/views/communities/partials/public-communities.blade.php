                            ...
                            <span class = "community-author">
                                ...
                                <a href = "{{ route('explore.users.show', $community->owner) }}" class = "d-inline-flex align-items-center text-decoration-none text-white-50 hover-text-white">
                                    ...
                                    @if($community->owner->profile_photo_path)
                                        ...
                                        <img src = "{{ $community->owner->profile_photo_url }}" alt = "{{ $community->owner->name }}" class = "rounded-circle me-2" style = "width: 20px; height: 20px; object-fit: cover;">
                        ...
                        <div class = "community-actions-section">
                            ...
                            @if($community->is_private)
                                ...
                                @else
                                    ...
                                    <button type = "button" class = "btn-community btn-community-primary btn-sm" data-bs-toggle = "modal" data-bs-target = "#requestModal{{ $community->id }}">
