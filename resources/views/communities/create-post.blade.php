                    ...
                    <div class = "mb-4 community-card">
                        ...
                        <div class = "d-flex align-items-center">
                            ...
                            @if($community->cover_image)
                                ...
                                <img src = "{{ asset('storage/' . $community->cover_image) }}" alt = "{{ $community->name }}" class = "rounded me-3" style = "width: 60px; height: 60px; object-fit: cover;">
                                ...
                                <div class = "row">
                                    ...
                                    <div class = "col-md-8 mb-4">
                                        ...
                                        <div class = "mb-4">
                                            ...
                                            <input type = "text" class = "form-control @error('title') is-invalid @enderror" id = "title" name = "title" value = "{{ old('title') }}" placeholder = "¿Qué quieres compartir con la comunidad?" required>
                                            @error('title')
