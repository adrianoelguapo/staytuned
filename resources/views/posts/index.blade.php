                                            ...
                                            <div class="post-info-container">
                                                ...
                                                <div class="post-footer-section">
                                                    ...
                                                    <div class="post-actions-section">
                                                        ...
                                                        <button onclick="toggleLike({{ $post->id }})" class="like-btn {{ Auth::check() && $post->isLikedBy(Auth::user()) ? 'liked' : '' }}" data-post-id="{{ $post->id }}" data-liked="{{ Auth::check() && $post->isLikedBy(Auth::user()) ? 'true' : 'false' }}">
                                                        ...
                                                        @if($post->user_id === Auth::id())
                                                            ...
                                                            <div class="post-actions-buttons">
                                                                ...
                                                                <a href="{{ route('posts.show', $post) }}" class="btn btn-glass-action" title="Ver publicación">

                                                                    <i class="bi bi-eye me-1"></i>Ver

                                                                </a>

                                                                <a href="{{ route('posts.edit', $post) }}" class="btn btn-glass-action" title="Editar publicación">
